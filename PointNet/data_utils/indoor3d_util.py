...
g_class2color = {'ceiling':	[0,255,0], #0 green
                 'floor':	[0,0,255], #1 blue
                 'wall':	[0,255,255], #2 cyan(light blue)
                 'beam':        [255,255,0],#3 yellow
                 'column':      [255,0,255],#4 pink
                 'window':      [100,100,255],#5
                 'door':        [200,200,100],#6
                 'table':       [170,120,200],#7 ori
                 'chair':       [255,0,0],#8 ori
                 'sofa':        [200,100,100],#9
                 'bookcase':    [10,200,100],#10 ori
                 'board':       [200,200,200],#11
                 'clutter': [50, 50, 50]} #12
for k, v in g_class2color.items():
    g_class2color[k] = [i / 255.0 for i in g_class2color[k]]
